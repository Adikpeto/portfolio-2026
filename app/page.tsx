...
const phrase = "Développeur Full Stack & Mobile basé à Cotonou, je conçois des applications web et mobiles pour des startups et scale-ups de l'architecture backend (Node.js, Laravel) aux interfaces React et Flutter. Je travaille en remote avec des clients européens, sur le même fuseau horaire que Paris";
        ...
        <div className="spoolight">
          <div className="header w-full">
            <div className="header-container flex flex-col">
              <div className="contact-title uppercase pl-10 pt-10">
                Des idées à la mise en ligne — web et mobile.
              </div>
              <div className="body">
                {
                  splitWords(phrase)
          ...
          {/* <ParallaxImage src="/peter-thomas-CkWqvaAljDY-unsplash.jpg" alt="" strength={0.35} height={"80vh"} width={"90vw"} /> */}
          
   
          <section className="w-[70%] section margin-top border-bottom-black border-2">
          
            <div className="w-full flex flex-row justify-center items-center">
              <div className="flex flex-col">
                <div className="flex flex-col">
                  <div className="text-[3rem] leading-none text-black font-bold">Creative Direction</div>
              ...
              <div className="flex flex-col">
                <div className="animate-card-container relative min-w-[50vw] min-h-[40vh] max-w-[50vw] max-h-[40vh] overflow-hidden">
                  <ParallaxImage src="/1.webp" alt="" strength={0.35} height={"70vh"} width={"60vw"} />
          ...
          <section className="w-[70%] section border-bottom-black border-2">
            <div className="w-full flex flex-row justify-center items-center">
              ...
              <div className="relative min-w-[50vw] min-h-[40vh] max-w-[50vw] max-h-[40vh] overflow-hidden">
                <ParallaxImage src="/2.webp" alt="" strength={0.35} height={"70vh"} width={"60vw"} />
                <div className="animate-card absolute inset-0 z-10 flex flex-col p-5 bg-black/20">
                  <h2 className="text-[#fff] text-base">
                          SHOP-COMMERCE. 
                       <Link href={"/detail"}>
          ...
          <section className="w-[70%] section border-bottom-black border-2">
            <div className="w-full flex flex-row gap-5 justify-center items-center">
              <div className="relative min-w-[50vw] min-h-[40vh] max-w-[50vw] max-h-[40vh] overflow-hidden">
                <ParallaxImage src="/7.webp" alt="" strength={0.35} height={"70vh"} width={"60vw"} />
                 <div className="animate-card absolute inset-0 z-10 flex flex-col p-5 bg-black/20">
                   <h2 className="text-[#fff] text-base">
                          SHOP-COMMERCE. 
                       <Link href={"/detail"}>
          ...
          <section className="w-[70%] section border-bottom-black border-2">
            <div className="w-full flex flex-row gap-2 justify-center items-center">
              <div className="flex flex-col">
                <div className="flex flex-col">
                  <div className="text-[3rem] text-black leading-none font-bold">Creative Direction</div>
                </div>
                <div className="process-step-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat ipsam nam ullam sit mollitia porro sequi atque fuga similique molestias suscipit aut dolores corrupti dolor labore illum, dicta iusto exercitationem?</div>
              </div>

              <div className="relative min-w-[50vw] min-h-[40vh] max-w-[50vw] max-h-[40vh] overflow-hidden">
                <ParallaxImage src="/10.webp" alt="" strength={0.35} height={"70vh"} width={"60vw"} />
                <div className="animate-card absolute inset-0 z-10 flex flex-col p-5 bg-black/20">
                   <h2 className="text-[#fff] text-base">
                          SHOP-COMMERCE. 
                      <Link href={"/detail"}>
          ...
          <section className="competence-section w-[100%] mt-[5rem] pt-[6rem] pb-[6rem] bg-black flex items-center justify-center">
            ...
            <div className="competence-container competence-row flex flex-row" style={{ opacity: 0, transform: "translateY(60px)" }}>
              ...
              <div className="competence-text text-sm text-[gray]">
                Maîtrise des technologies React, Node.js, Laravel et bases de données pour des architectures complètes et robustes.
              </div>
            ...
            <div className="competence-container competence-row flex flex-row" style={{ opacity: 0, transform: "translateY(60px)" }}>
              ...
              <div className="competence-text text-sm text-[gray]">
                Création d'applications fluides et performantes avec React Native et Flutter, garantissant une ergonomie irréprochable.
              </div>
            ...
            <div className="competence-container competence-row flex flex-row" style={{ opacity: 0, transform: "translateY(60px)" }}>
              ...
              <div className="competence-text text-sm text-[gray]">
                Élaboration d'architectures backend solides, évolutives et sécurisées, validées par des tests.
              </div>
            ...
            <div className="competence-container competence-row flex flex-row" style={{ opacity: 0, transform: "translateY(60px)" }}>
              ...
              <div className="competence-text text-sm text-[gray]">
                Création d'expériences numériques percutantes centrées sur l'utilisateur et hautement performantes.
              </div>
           ...
           <BezierDivider intensity={0.6}/>
            ...
            <div className="competence-container competence-row flex flex-row" style={{ opacity: 0, transform: "translateY(60px)" }}>
              ...
              <div className="competence-text text-sm text-[gray]">
                Avide de défis techniques, je conçois des solutions innovantes pour répondre aux exigences complexes de vos projets.
              </div>
